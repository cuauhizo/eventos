...
// =========================================================================
// CORRECCIÓN: Instanciar los controladores AQUÍ, antes de cualquier lógica
// =========================================================================
...
$admin_actions = ['admin_dashboard', 'admin_eventos_list', 'admin_evento_form', 'admin_guardar_evento', 'admin_eliminar_evento'];
...
switch ($action) {
    ...
    case 'login':
        if ($_SERVER['REQUEST_METHOD'] === 'POST') {
            ...
            if ($resultado === true) {
                ...
                // Ahora, obtén el rol del usuario para guardarlo en la sesión
    ...
    case 'mis_reservas': // NUEVO: Acción para ver las reservas del usuario
    ...
    case 'reservar':
        if ($_SERVER['REQUEST_METHOD'] === 'POST') {
            ...
            if (is_int($resultado)) { // Si el resultado es un entero, es el ID del grupo
                ...
                $_SESSION['reserva_mensaje'] = $resultado; // Mensaje de error
                header("Location: " . $_SERVER['PHP_SELF'] . "?action=eventos");
                exit();
            }
        } else {
    ...
    case 'resumen_reservas': // Ahora esta página solo muestra un resumen antes de la confirmación final
    ...
    case 'finalizar_reserva': // NUEVO: Confirmación final y envío de correo
